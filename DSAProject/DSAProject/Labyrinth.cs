...
namespace DSAProject
{
    public partial class Labyrinth : Form
    {
        ...
        {
            label1.Text = "Status: Not Started";
            for (int i = 0; i < 8; i++)
            {
                for (int j = 0; j < 8; j++)
                {
        ...
        {
            DisplayCounter.Text = ("Moves: " + points);
        }
        ...
        {
            if (DisplayCounter.Enabled == false && buttons()[row, col].BackColor != Color.Green)
            {
        ...
        private void DisplayCounter_Click(object sender, EventArgs e)
        {
            DisplayCounter.Enabled = false;
            label1.Text = "Status: Game in Progress";
            DisplayCounter.BackColor = Color.White;
            DisplayCounter.FlatStyle = FlatStyle.Flat;
            DisplayCounter.UseVisualStyleBackColor = false;
            UpdateDisplay();
        }
    }
}
